...
def frid_a():
    ...
    count = 0
    with open("Friday\Afternoon.txt",'r') as fp:
        Lines = fp.readlines()
        for line in Lines:
            count += 1
    ...
    global frid_ao
    frid_ao  = ((szamlalo1 + szamlalo2 + szamlalo3 + szamlalo4 + szamlalo5 + szamlalo6 + szamlalo7 + szamlalo8) *4000)
    print("*******************************************************************************")
    print(f'Péntek délután összesen {(szamlalo1 + szamlalo2 + szamlalo3 +szamlalo4+ szamlalo5 + szamlalo6 + szamlalo7 + szamlalo8) * 4000} Ft volt a bevétel.')
    print("*******************************************************************************")
