...
def thu_a():
    ...
    count = 0
    with open("Thursday\Afternoon.txt",'r') as fp:
        Lines = fp.readlines()
        for line in Lines:
            count += 1
    ...
    global thu_ao
    thu_ao = (szamlalo1 + szamlalo2 + szamlalo3 + szamlalo4 + szamlalo5 + szamlalo6 + szamlalo7 + szamlalo8) * 4000
    print("*******************************************************************************")
    print(f'Csütörtök délután összesen {(szamlalo1 + szamlalo2 + szamlalo3 +szamlalo4+ szamlalo5 + szamlalo6 + szamlalo7 + szamlalo8) * 4000} Ft volt a bevétel.')
    print("*******************************************************************************")
