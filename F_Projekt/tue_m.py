...
def tue_m():
    ...
    count = 0
    with open("Tuesday\Morning.txt",'r') as fp:
        Lines = fp.readlines()
        for line in Lines:
            count += 1
    ...
    print("*******************************************************************************")
    print(f'Kedd reggel összesen {(szamlalo1 + szamlalo2 + szamlalo3 +szamlalo4+ szamlalo5 + szamlalo6 + szamlalo7 + szamlalo8) * 4000} Ft volt a bevétel.')
    print("*******************************************************************************")
