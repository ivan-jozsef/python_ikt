...
def sun_e():
    ...
    count = 0
    with open("Sunday\Evening.txt",'r') as fp:
        Lines = fp.readlines()
        for line in Lines:
            count += 1
    ...
    global sue_o
    sue_o = (szamlalo1 + szamlalo2 + szamlalo3 + szamlalo4 + szamlalo5 + szamlalo6 + szamlalo7 + szamlalo8) * 4000
    print("*******************************************************************************")
    print(f'Vasárnap este összesen {(szamlalo1 + szamlalo2 + szamlalo3 +szamlalo4+ szamlalo5 + szamlalo6 + szamlalo7 + szamlalo8) * 4000} Ft volt a bevétel.')
    print("*******************************************************************************")
