...
def menu():
    print("1. Foglalás")
    print("2. Bevétel ellenőrzés: Napi-időszaki összbevétel, termek bevétele, asztalok bevétele, Heti - és napi bevétel. Kiírva: bevetel.txt fájlba.")
    print("3. Kilépés")
