...
def sat_a():
    ...
    count = 0
    with open("Saturday\Afternoon.txt",'r') as fp:
        Lines = fp.readlines()
        for line in Lines:
            count += 1
    ...
    global sat_ao
    sat_ao = (szamlalo1 + szamlalo2 + szamlalo3 + szamlalo4 + szamlalo5 + szamlalo6 + szamlalo7 + szamlalo8) * 4000
    print("*******************************************************************************")
    print(f'Szombat délután összesen {(szamlalo1 + szamlalo2 + szamlalo3 +szamlalo4+ szamlalo5 + szamlalo6 + szamlalo7 + szamlalo8) * 4000} Ft volt a bevétel.')
    print("*******************************************************************************")
